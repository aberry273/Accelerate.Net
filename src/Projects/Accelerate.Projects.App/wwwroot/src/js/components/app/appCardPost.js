          ...
          <footer>
            <nav>
              <ul>
                <li>
                  <!--Agree-->
                  <i aria-label="Agree" @click="action('agree')" :class="agrees(data) == true ? 'primary': ''" class="icon material-icons icon-click" rel="prev">expand_less</i>
                  <sup class="noselect" rel="prev" x-text="data.agrees || 0"></sup>
                  <!--Disagree-->
                  <i aria-label="Disagree" @click="action('disagree')" :class="disagrees(data) == true ? 'primary': ''" class="icon material-icons icon-click" rel="prev">expand_more</i>
              ...
              <ul>
                <li>
                  <i @click="action('like')" aria-label="Liked" :class="likes(data) == true ? 'primary': ''" class=" icon material-icons icon-click" rel="prev">favorite</i>
