...
namespace Accelerate.Features.Content.Controllers
{
    ...
    public class IndividualController : BaseAccountsController<AccountsIndividualEntity>
    {
        const string channelName = "Individual";
        public IndividualController(
            ...
            IEntityService<AccountsIndividualEntity> entityService,
            IAccountsBaseEntityViewService<AccountsIndividualEntity> contentViewService)
