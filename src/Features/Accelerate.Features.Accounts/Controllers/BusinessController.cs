...
namespace Accelerate.Features.Content.Controllers
{
    ...
    public class BusinessController : BaseAccountsController<AccountsBusinessEntity>
    {
        const string channelName = "Business";
        public BusinessController(
            ...
            IEntityService<AccountsBusinessEntity> entityService,
            IAccountsBaseEntityViewService<AccountsBusinessEntity> contentViewService)
