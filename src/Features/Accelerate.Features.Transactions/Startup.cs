...
namespace Accelerate.Features.Transactions
{
    public static class Startup
    {
        ...
        {
            await CreateRole(roleService, Foundations.Portal.Constants.Roles.TransactionsTransaction, "Internal portal role for a Transactions Bank Account");
        ...
        public static void ConfigureApp(WebApplication app)
        {
            ...
            using (var scope = app.Services.CreateScope())
            {
                ...
                //Task.FromResult(CreateGlobalTransactions(userManager));
        ...
        {
            services.AddTransient<ITransactionsBaseEntityViewService<TransactionsTransactionEntity>, TransactionsTransactionViewService>();
        }
    }
}
