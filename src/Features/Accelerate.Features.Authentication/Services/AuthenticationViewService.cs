...
namespace Accelerate.Features.Authentication.Services
{
    public class AuthenticationViewService : IAuthenticationViewService
    {
        ...
        public ManagePage GetManagePage(UsersUser user)
        {
            ...
            {
                GetPageLink(nameof(AuthenticationController.Profile)),
                //GetPageLink(nameof(AuthenticationController.Posts)),
                //GetPageLink(nameof(AccountController.Mentions)),
                //GetPageLink(nameof(AuthenticationController.Media)),
                //GetPageLink(nameof(AuthenticationController.Notifications)),
