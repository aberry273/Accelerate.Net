using Accelerate.Features.Authentication.Models;
using Accelerate.Features.Authentication.Pipelines;
using Accelerate.Features.Authentication.Services;
...
namespace Accelerate.Features.Authentication
{
    public static class Startup
    {
        ...
        {
            services.AddTransient<IAuthenticationViewService, AuthenticationViewService>();
