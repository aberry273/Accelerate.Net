...
{
    [Route("[controller]")]
    public class ListsController : BaseContentController<ContentListDocument>
    {
        const string channelName = "List";
        public ListsController(
            ...
            IBaseContentEntityViewService<ContentListDocument> contentViewService,
