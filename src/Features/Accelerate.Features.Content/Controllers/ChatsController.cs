...
{
    [Route("[controller]")]
    public class ChatsController : BaseContentController<ContentChatDocument>
    {
        const string channelName = "Chat";
        public ChatsController(
            ...
            IBaseContentEntityViewService<ContentChatDocument> contentViewService, 
