...
namespace Accelerate.Features.Content.Controllers
{
    public class ThreadsController : BaseController
    {
        ...
        public async Task<IActionResult> Thread([FromRoute]Guid id)
        {
            ...
            var item = await _contentViewSearchService.UpdatePostDocument(user.Id, response.Source);
            ...
            */
            ...
            viewModel.Thread = await _contentViewSearchService.UpdatePostDocuments(user.Id, parentResults.Posts.ToList());
