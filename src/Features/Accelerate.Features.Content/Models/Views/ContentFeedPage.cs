...
{
    public class ContentChatPage : ContentBasePage
    {
        public ContentChatPage(ContentBasePage model) : base(model)
        {/*
        ...
        public AclAjaxListing<ContentChatDocument> Listing { get; set; }
