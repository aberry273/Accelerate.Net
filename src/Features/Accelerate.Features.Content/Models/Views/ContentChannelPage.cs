...
{
    public class ContentChannelPage : ContentBasePage
    {
        public ContentChannelPage(ContentBasePage model) : base(model)
        {/*
        ...
        public AclAjaxListing<ContentChannelDocument> Listing { get; set; }
