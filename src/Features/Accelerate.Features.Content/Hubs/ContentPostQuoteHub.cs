...
{
    public class ContentPostQuoteHub : BaseHub<ContentPostQuoteDocument>
    {
        ...
        public override List<string> GetConnections(string user, WebsocketMessage<ContentPostQuoteDocument> message)
