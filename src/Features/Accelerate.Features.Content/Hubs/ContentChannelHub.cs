...
{
    public class ContentChannelHub : BaseHub<ContentChannelDocument>
    {
        ...
        public override List<string> GetConnections(string user, WebsocketMessage<ContentChannelDocument> message)
