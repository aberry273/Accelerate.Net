...
{ 
    ...
    public class WalletController : BaseFundingController<FundingWalletEntity>
    {
        const string channelName = "Wallet";
        public WalletController(
            ...
            IEntityService<FundingWalletEntity> entityService,
            IFundingBaseEntityViewService<FundingWalletEntity> contentViewService)
