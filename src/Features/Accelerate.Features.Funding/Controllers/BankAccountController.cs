...
{ 
    [Route("Funding/[controller]")]
    public class BankAccountController : BaseFundingController<FundingBankAccountEntity>
    {
        const string channelName = "BankAccount";
        public BankAccountController(
            ...
            IEntityService<FundingBankAccountEntity> entityService,
            IFundingBaseEntityViewService<FundingBankAccountEntity> contentViewService)
