...
namespace Accelerate.Features.Funding
{
    public static class Startup
    {
        ...
        {
            await CreateRole(roleService, Foundations.Portal.Constants.Roles.FundingBankAccount, "Internal portal role for a Funding Bank Account");

            await CreateRole(roleService, Foundations.Portal.Constants.Roles.FundingWallet, "Internal portal role for a Funding Wallet ");
        ...
        public static void ConfigureApp(WebApplication app)
        {
            ...
            using (var scope = app.Services.CreateScope())
            {
                ...
                //Task.FromResult(CreateGlobalFunding(userManager));
        ...
        {
            services.AddTransient<IFundingBaseEntityViewService<FundingBankAccountEntity>, FundingBankAccountViewService>();
        }
    }
}
