...
namespace Accelerate.Features.Content.Controllers
{
    ...
    public class IndividualsController : BaseAdminController<AccountsIndividualEntity>
    {
        ...
        public IndividualsController(
            ...
            IAdminBaseEntityViewService<AccountsIndividualEntity> contentViewService)
