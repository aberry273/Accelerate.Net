...
{
    public enum ContentListEntityStatus
    {
        Hidden, Public, Archived
    }
    [Table("ContentLists")]
    public class ContentListEntity : BaseEntity
    {
        ...
        public ContentListEntityStatus Status { get; set; } = ContentListEntityStatus.Hidden;
