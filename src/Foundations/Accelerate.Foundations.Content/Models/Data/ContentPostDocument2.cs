...
namespace Accelerate.Foundations.Content.Models.Data
{
    ...
    public class ContentPostQuote2Subdocument
    {
    ...
    public class ContentPostTaxonomy2Subdocument
    {
    ...
    public class ContentPostDocument2 : EntityDocument
    {
        ...
        public IEnumerable<ContentPostQuote2Subdocument>? QuotedPosts { get; set; }
        public IEnumerable<ContentPostMediaSubdocument>? Media { get; set; }
        // Computed
        public ContentPostTaxonomy2Subdocument Taxonomy { get; set; }
        ...
        public List<ContentPostDocument2> Pages { get; set; }
